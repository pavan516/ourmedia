...
<title itemprop="name">News - OurMedia | Now Publish Your Articles For Free Of Cost</title>
        ...
        <div class="col-md-6">
	        ...
	        <!-- POSTS ON NEWS -->
				...
				<?php
					...
					include("connect.php");
					include('news_pagination/function.php');
	                ...
	                $get_posts = "SELECT * from newsposts where post_newstatus='approved' ORDER by 1 DESC LIMIT ".$pageLimit." , ".$setLimit." ";
