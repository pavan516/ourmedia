...
<center><h3 style="color:green;">Startup's Categories</h3></center>
...
<?php
						...
						while ($cats_row=mysqli_fetch_array($run_cats))
						{
							...
							echo "<a href='startupscatg.php?cat=$encoded_cat_id'>$cat_title</a>";
                            echo "</div>";							
						}
...
<?php
						...
						while ($cats_row=mysqli_fetch_array($run_cats))
						{
							...
							echo "<div class='list-item'>";
							echo "<a href='newscatg.php?cat=$encoded_cat_id'>$cat_title</a>";
							echo "</div>";
						}
...
<?php
						...
						while ($cats_row=mysqli_fetch_array($run_cats))
						{
							...
							echo "<div class='list-item'>";
							echo "<a href='eventscatg.php?cat=$encoded_cat_id'>$cat_title</a>";
                            echo "</div>";							
						}
