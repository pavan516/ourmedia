		        ...
		        <div class="col-md-8">
				    ...
				    <div class="box shadow postblock">
					    ...
					    include("connect.php");
				            ...
				            $get_posts = "select * from newsposts where user_id='$user_id' order by 1 DESC";
		            ...
		            <div class="box shadow postblock">
                       ...
                       <?php echo "
						<div class='foot' align='right'>
   		                    <a href='https://www.ourmedia.in/details.php?post=$encoded_post_id' class='btn btn-default'><i class='fa fa-eye'></i> View</a>
				            <a href='https://www.ourmedia.in/editnews_post.php?post_id=$encoded_post_id' class='btn btn-default'><i class='fa fa-pencil'></i> Edit</a>
				            <a href='https://www.ourmedia.in/deletenews_post.php?post_id=$encoded_post_id' class='btn btn-default'><i class='fa fa-remove'></i> Delete</a>
		                </div>";
						?><?php include('deletenews_post.php'); ?>
