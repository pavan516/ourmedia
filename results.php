				...
				?>
		            <div class="box shadow postblock">
						...
						<h5>
							...
							<strong><?php echo "<a style='color:red;' href='https://www.ourmedia.in/user_profile.php?u_id=$user_id'>$user_name</a>";?></strong>
						...
						<h3>	
							<?php echo "<a style='color:purple;'href='https://www.ourmedia.in/details.php?post=$post_id'>$post_title</a>"; ?>
						</h3>	
                        ...
                        <div class="foot" align="right"> 
						    <?php echo "<a href='https://www.ourmedia.in/details.php?post=$post_id' class='btn btn-default'>Read More <i class='fa fa-angle-right'></i><i class='fa fa-angle-right'></i></a>"; ?>
						</div>
					...
					<div class="box shadow postblock">
						...
						<h3>	
							<?php echo "<a style='color:purple;'href='https://www.ourmedia.in/eventsdetails.php?post=$post_id'>$post_title</a>"; ?>
						</h3>	
                        ...
                        <div class="foot" align="right"> 
						    <?php echo "<a href='https://www.ourmedia.in/eventsdetails.php?post=$post_id' class='btn btn-default'>Read More <i class='fa fa-angle-right'></i><i class='fa fa-angle-right'></i></a>"; ?>
						</div>
					...
					<div class="box shadow postblock">
						...
						<h3>	
							<?php echo "<a style='color:purple;'href='https://www.ourmedia.in/startupsdetails.php?post=$post_id'>$post_title</a>"; ?>
						</h3>	
                        ...
                        <div class="foot" align="right"> 
						    <?php echo "<a href='https://www.ourmedia.in/startupsdetails.php?post=$post_id' class='btn btn-default'>Read More <i class='fa fa-angle-right'></i><i class='fa fa-angle-right'></i></a>"; ?>
						</div>
