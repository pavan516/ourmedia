	        ...
	        <div class="box shadow postblock">
				...
				<div class="box shadow postblock">
							...
							<div class="box shadow postblock">
								...
								$run = mysqli_query($mysqli,$user);
								$count_users = mysqli_num_rows($run);?>
								
							    <center><h4 style="color:purple;">Members In OurMedia : <?php echo "<span style='color:purple;'>$count_users</span>"; ?></h4></center><br>
								...
								?>									
									<div class="box shadow postblock"><br>
								        ...
								        <table>
											...
											<tr><td>Password : </td><td><?php echo $user_pass ?></td></tr>
											...
											<tr><td>Approved </td> : <td><?php echo $verification ?></td></tr>
						                    
						                </table><br>
								        <center><button><a href="delete_user.php?user_id=<?php echo $user_id ?>" >Delete</a></button></center>
