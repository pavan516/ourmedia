	...
	?>
	    ...
	    <div class="box shadow postblock">										
			...
			<?php echo "<a style='font-size:120%;color:purple;' href='eventsdetails.php?post=$encoded_post_id'>$post_title </a>"; ?><br><br>
	...
	?>                      
		...
		<div class="box shadow postblock">										
			...
			<p style='font-size:80%;color:purple;'><?php echo " Posted On : $post_date"; ?></p>
			<?php echo "<a style='font-size:120%;color:purple;' href='startupsdetails.php?post=$encoded_post_id'>$post_title </a>"; ?><br><br>
	...
	<?php
		...
		$get_posts = "select * from newsposts order by 1 DESC LIMIT 0,5";
	...
	?>
        ...
        <div class="box shadow postblock">										
			...
			<p style='font-size:80%;color:purple;'><?php echo " Posted On : $post_date"; ?></p>
			<?php echo "<a style='font-size:120%;color:purple;' href='details.php?post=$encoded_post_id'>$post_title </a>"; ?><br><br>
