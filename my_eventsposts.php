		    ...
		    <div class="row">
		        ...
		        <div class="col-md-8">
				    ...
				    <div class="box shadow postblock">
						...
						<center><h3 style="color:purple;">My Posts On Events</h3></center>
						<div class="box shadow postblock">
					...
					<div class="box shadow postblock">
						...
						<h3>	
							<?php echo "<a style='color:purple;'https://www.ourmedia.in/href='eventsdetails.php?post=$encoded_post_id'>$post_title</a>"; ?>
						</h3>	
                       ...
                       <?php echo "
						<div class='foot' align='right'>
   		                    <a href='https://www.ourmedia.in/eventsdetails.php?post=$encoded_post_id' class='btn btn-default'><i class='fa fa-eye'></i> View</a>
				            <a href='https://www.ourmedia.in/editevents_post.php?post_id=$encoded_post_id' class='btn btn-default'><i class='fa fa-pencil'></i> Edit</a>
				            <a href='https://www.ourmedia.in/deleteevents_post.php?post_id=$encoded_post_id' class='btn btn-default'><i class='fa fa-remove'></i> Delete</a>
		                </div>";
						?><?php include('deleteevents_post.php'); ?>
