...
<title itemprop="name">OurMedia - Events | Now promote your Events by single post and get more audience</title>
	        ...
	        <div class="box shadow postblock">
			    ...
			    <div class="box shadow postblock">
					...
					<?php
						...
						include("connect.php");
						include('events_pagination/function.php');
	                    ...
	                    $get_posts = "SELECT * from eventsposts ORDER by 1 DESC LIMIT ".$pageLimit." , ".$setLimit." ";						
					...
					<div class="box shadow postblock">
						...
						<h3>
						    <?php echo "<img src='events_images/$post_image' width='500' height='300' />"; ?><br>
						</h3>
