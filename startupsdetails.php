...
<title itemprop="name">Ourmedia - Startups | <?php echo "$post_title"; ?></title>
...
<div class="content">
    <div class="container">
	    ...
	    <div class="col-md-12">
			<h3 class="pullbar"><i class="fa fa-bars" onclick="$('.col-left').slideToggle();"></i> STARTUPS
        ...
        <div class="col-md-6">	
	        ...
	        <div class="box shadow postblock">
                ...
                <center><h3 style="color:green;">Latest Posts On Starups</h3></center>
				...
				<?php
					...
					if(isset($_GET['post']))
					{
                        ...
                        mysqli_query($mysqli,"UPDATE startupsposts SET view=view+1 WHERE post_id='$post_id'");
                ...
                <div class="box shadow postblock">
                    ...
                    <h5>
                        ...
                        <p>
							...
							<strong style='color:grey;'>Views :</strong> 345</small>
						</p><hr />
					...
					<?php echo "<img src='startups_images/$post_image' width='520' height='300' />"; ?><br><br>
					...
					<div class="text">
					    <center><h2>Founder Details :</h2></center>
						<?php echo "G-Mail : $post_fgmail"; ?><br>
					    <?php echo "Contact : $post_fcontact"; ?><br>
					</div>
                ...
                include("connect.php");
             	...
             	if(isset($_GET['post']))
					{							
						...
						$get_posts = "select * from comments_startups where post_id='$post_id'";
		        ...
		        <h4>Post A Comment -</h4>
					...
					<?php
                                ...
                                if(isset($_POST['submit']))
                                {
	                                ...
	                                $content = "You Successfully Commented On A Article : $post_title";
									$status = 'unread';
									
									$insertq_posts = "insert into notifications (user_id,content,post_date,status)
                	                values ('$user_id','$content',NOW(),'$status')";
	
	                                $run_noti = mysqli_query($mysqli,$insertq_posts);
					...
					<?php
                        ...
                        { 
	                       ...
	                       $user = $_SESSION['user_email'];
	                        ...
	                        {
		                        $query_comment = "insert into comments_startups (post_id,user_id,comment_text) values('$post_id','$user_id','$comment')";
                                ...
                                if($run_query)
		                        {
                                    ...
                                    echo "<script>window.open('https://www.ourmedia.in/startupsdetails.php','_self')</script>";		   
                                }
								$from = "From: ourmedia.in@gmail.com";
		                        $to = $user;
		                        $subject = "OurMedia Alerts";
         
		                        $body = "$user_name You Successfully Commented On A Article : $post_title";
