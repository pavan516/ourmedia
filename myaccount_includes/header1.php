    ...
    <div class="row">
        ...
        <div class="col-md-5" style="text-align:right;">
			...
			else
			{
				...
				{
					echo "<a href='notifications.php'><i class='fa fa-bullhorn'></i> <span>Notifications</span></a>";
				}
				else
				{
					echo "<a href='notifications.php'><i class='fa fa-bullhorn'></i> <span data-notifications='$notifications_count'>Notifications</span></a>&nbsp&nbsp&nbsp";
				}
				?>
    ...
    <div class="container">
        <div class="row">
            <ul>
                ...
                <li><a href="insert_newsposts.php">POST ON NEWS</a></li>
                <li><a href="insert_eventsposts.php">POST ON EVENTS</a></li>
                <li><a href="insert_startupsposts.php">POST ON STARTUPS</a></li>  
        ...
        <div class="container">
            <div class="row">
                <ul>
				    ...
				    <li><a href='startups.php'><i class="fa fa-newspaper-o"></i> STARTUPS</a></li>
                    <li><a href="insert_newsposts.php"><i class="fa fa-newspaper-o"></i> POST ON NEWS</a></li>
                    <li><a href="insert_eventsposts.php"><i class="fa fa-newspaper-o"></i> POST ON EVENTS</a></li>
                    <li><a href="insert_startupsposts.php"><i class="fa fa-newspaper-o"></i> POST ON STARTUPS</a></li>
					<?php
					$user = $_SESSION['user_email'];
				    $get_user = "select * from users where user_email='$user'";
				    $run_user = mysqli_query($mysqli,$get_user);
                    ...
                    <li><a href="userhome.php" style="float:right;"><span class="profile-pic" style="background:url('<?php echo "user_images/$user_image"; ?>'); padding: 15px; border-radius: 50%;"></span><?php echo $user_name ?></a></li>
                    <?php } ?>                    
                </ul>
            </div>
        </div>
