...
<title itemprop="name">OurMedia - Startups Categories| Now promote your startup and hire your partners</title>
			    ...
			    <div class="box shadow postblock">
					...
					<?php
						...
						if(isset($_GET['cat']))
						{
						    ...
						    $get_posts = "select * from startupsposts where category_id = '$cat_id' ORDER by 1 DESC";
